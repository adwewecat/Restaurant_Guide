...
def dashboard():
    ...
    return render_template('QUAN_TRI/index.html',HUONGDAN_LIST = Markup(huongdan_list),THUONGXUYEN_LIST = Markup(thuongxuyen_list),KHAC_LIST = Markup(khac_list),DOITAC_LIST = )
    # return render_template('login.html',USER = user1 , PASS = pass1)
