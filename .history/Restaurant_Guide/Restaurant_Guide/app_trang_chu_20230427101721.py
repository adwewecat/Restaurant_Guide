...
def huongdan_app(key_app):
    connection_2014 = connect_SQL_Web_NH_172_16_8_19()
    conn_2014 = connection_2014.cursor()
    sql = "SELECT id,TACVU_CHINH,TACVU_PHU,FILE_DINHKEM,TENKHONGDAU_LON,TENKHONGDAU_NHO,VERSION_APP,NOTE FROM dbo.HUONGDAN_CHUNG_APP WHERE ID_APP_ALL='"+str(key_app)+"' AND ACTIVE='1' ORDER BY NGAY_INSERT"
    sql1 = str(sql)
    ...
    if danh_sach is not None:
        ...
        danhsach_html = '''len(danh_sach)
                      <tr>
                            <td class="chinhlai_input_the_td" rowspan="2"'''+str()+'''><input class="input_table" value="'''+str(tacvu_chinh)+'''"></td>
                        '''
        for item in danh_sach:
            id =item[0]    
            tacvu_chinh = item[1]
            tacvu_phu = item[2]
            tenkhongdau_lon = item[3]
            tenkhongdau_nho = item[4]
            version_app = item[5]
            note = item[6]
            ...
            # danhsach_html ='''
            #                 <tr>
            #                 <td class="chinhlai_input_the_td"><input class="input_table" value="'''+str(tacvu_chinh)+'''"></td>
            #                 '''
            danhsach_html += '''
                        <tr>
                            <td class="chinhlai_input_the_td"><input class="input_table" value="'''+str(tacvu_chinh)+'''"></td>
                            <td class="chinhlai_input_the_td"><input class="input_table" value=""></td>
                            <td class="chinhlai_input_the_td"><a href="link/to/your/download/file" download>Download link</a></td>
                            <td class="chinhlai_input_the_td"><input class="input_table" value=""></td>
                        </tr>
                        '''
