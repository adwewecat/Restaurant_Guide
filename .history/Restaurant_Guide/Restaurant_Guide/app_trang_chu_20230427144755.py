        ...
        for item in danh_sach:
            ...
            danhsach_html += '''
                        <tr>
                            ...
                            <td style="width:100px"><select  style="width: 100%; height: 50px; border: 0; padding-left: 15px;" name="TRANGTHAI" id="'''+str(id)+'''" onblur="iWillCallWhenBlur(this)">
                                <option label=""></option>
                                <option label="BU">BU</option>
                                <option label="FC">FC</option>
                                <option label="MD">MD</option>
                                <option label="DONE">DONE</option>
                            </select></td>
