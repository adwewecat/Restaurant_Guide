        ...
        for item in danh_sach:
            ...
            danhsach_html += '''
                        <tr>
                            ...
                            <td class="chinhlai_input_the_td"><input class="input_table" value="'''+str(version_app)+'''"></td>
                            <td class="chinhlai_input_the_td" hidden><input class="input_table" value="'''+str(tenkhongdau_lon)+'''"></td>
                            <td class="chinhlai_input_the_td" hidden><input class="input_table" value="'''+str(tenkhongdau_nho)+'''"></td>
                            <td class="chinhlai_input_the_td" hidden><input class="input_table" value=""></td>
                        </tr>
                        '''
