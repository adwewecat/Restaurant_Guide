...
def dashboard():
    ...
    if danh_sach is not None:
        for item in danh_sach:
            ...
            if is_huongdan == 'True':
                huongdan_list='''
                                <a href="/huongdan/'''+str(appname)+'''" class="col-sm-6 col-xl-3" title="028.7300.7430 Nhánh 2"> 
                                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                        <i class="fa-solid fa-shapes fa-2xl text-primary" style="color: #DBAC17;"></i>
                                        <div class="ms-3">
                                            <p class="mb-2">SAP</p>
                                            <h6 class="mb-0" >Hotline : IT ext 2</h6>
                                        </div>
                                    </div>
                                </a>
                            '''
