...
def huongdan_app(key_app):
    ...
    if len(danh_sach) != 0:
        ...
        for item in danh_sach:
            ...
            danhsach_html += '''
                        <tr>
                            <td class="chinhlai_input_the_td"><input id="'''+str(id)+'''" onblur="iWillCallWhenBlur(this)" class="input_table" name='tacvu_chinh' value="'''+str(tacvu_chinh)+'''"></td>
                            <td class="chinhlai_input_the_td"><input id="'''+str(id)+''' class="input_table" value="'''+str(tacvu_phu)+'''"></td>
