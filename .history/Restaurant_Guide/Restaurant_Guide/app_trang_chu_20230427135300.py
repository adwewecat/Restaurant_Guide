...
def huongdan_app(key_app):
    ...
    if len(danh_sach) != 0:
        ...
        for item in danh_sach:
            ...
            danhsach_html += '''
                        <tr>
                            <td class="chinhlai_input_the_td"><input name="tacvu_chinh" id="'''+str(id)+'''" class="input_table" name='tacvu_chinh' value="'''+str(tacvu_chinh)+'''"></td>
                            <td class="chinhlai_input_the_td"><input name="tacvu_chinh" id="'''+str(id)+'''"  class="input_table" value="'''+str(tacvu_phu)+'''"></td>
                            <td class="chinhlai_input_the_td"><a href="link/to/your/download/file" download>'''+str(ten_file)+'''</a></td>
                            <td class="chinhlai_input_the_td"><input  name="tacvu_chinh" id="'''+str(id)+'''"  class="input_table" value="'''+str(version_app)+'''"></td>
