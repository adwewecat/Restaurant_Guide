...
def huongdan_app(key_app):
    ...
    if danh_sach is not None:
        ...
        soluong_chieucao = 45*soluong_gomcot
        danhsach_html = '''
                      <tr>
                            <td class="chinhlai_input_the_td" rowspan="'''+str(soluong_gomcot)+'''"><input style="height: px;" class="input_table" value="'''+str(danh_sach[1][1])+'''"></td>
                        '''
        for item in danh_sach:
            id =item[0]    
            tacvu_chinh = item[1]
