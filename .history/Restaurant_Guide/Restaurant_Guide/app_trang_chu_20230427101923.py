...
def huongdan_app(key_app):
    ...
    if danh_sach is not None:
        ...
        danhsach_html = '''
                      <tr>
                            <td class="chinhlai_input_the_td" rowspan="'''+str(soluong_gomcot)+'''"><input class="input_table" value="'''+str(tacvu_chinh)+'''"></td>
                        '''
        for item in danh_sach:
            id =item[0]    
            tacvu_chinh = item[1]
            ...
            note = item[6]
            danhsach_html += '''
                            <td class="chinhlai_input_the_td"><input class="input_table" value="'''+str(tacvu_phu)+'''"></td>
                            <td class="chinhlai_input_the_td"><a href="link/to/your/download/file" download>'''+str(tacvu_chinh)+'''</a></td>
