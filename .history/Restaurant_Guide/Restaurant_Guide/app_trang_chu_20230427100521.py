...
def huongdan_app(key_app):
    ...
    if danh_sach is not None:
        for item in danh_sach:
            ...
            danhsach_html += '''
                            ...
                            <td class="chinhlai_input_the_td"><input class="input_table" value=""></td>
                            <td class="chinhlai_input_the_td"><a href="https://vat.ggg.com.vn/" class="col-sm-6 col-xl-3" target="_blank">teenfile.xxx</a></td>
                            <td class="chinhlai_input_the_td"><input class="input_table" value=""></td>
                        </tr>
    ...
    return render_template('QUAN_TRI/huongdan_app.html') 
    # return render_template('login.html',USER = user1 , PASS = pass1)
# ===========================ĐĂNG Xuat END=====================================
# ===========ĐĂNG Xuat END===================
