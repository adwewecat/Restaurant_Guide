...
def dashboard():
    ...
    if danh_sach is not None:
        for item in danh_sach:
            ...
            if is_huongdan == 'True':
                huongdan_list +='''
                                <a href="/huongdan/'''+str(appname)+'''" class="col-sm-6 col-xl-3" title="'''+str(hotline)+'''"> 
                                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                        <i class="'''+str(logo)+'''" style="color: #DBAC17;"></i>
                                        <div class="ms-3">
                                            <p class="mb-2">SAP</p>
                ...
                if classify == 'thuong_xuyen':
                    thuongxuyen_list += '''
                                    <tr>
                                        <td>SAP</td>
                                        <td><a href="https://wd-prd.ggg.com.vn/fiori" class="col-sm-6 col-xl-3" target="_blank">Link truy cập</a></td>
                                        <td>028.7300.7430 Nhánh 2</td>
                                    </tr>
                                        '''
                elif classify == 'khac':
                    print('')
    ...
    return render_template('QUAN_TRI/index.html')
    # return render_template('login.html',USER = user1 , PASS = pass1)
...
# ===========================ĐĂNG Xuat Start=====================================
# ===========================ĐĂNG Xuat Start=====================================
@app.route('/hotline_all', methods=['GET', 'POST'])
def hotline_all():


    return render_template('QUAN_TRI/hotline_all.html') 
    # return render_template('login.html',USER = user1 , PASS = pass1)
# ===========================ĐĂNG Xuat END=====================================
# ===========ĐĂNG Xuat END===================
